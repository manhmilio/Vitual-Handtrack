...
- Run using Python 3.10/3.11 (recommended on Windows for MediaPipe compatibility). Example with conda:
	- `conda create -n VitualPainter python=3.10`
	- `conda activate VitualPainter`
	- `pip install -r requirements.txt`
	- `python paint.py`
